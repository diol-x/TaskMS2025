<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="creatorId" label="创建主管工号" width="120" />
      ...
      <el-table-column prop="operate" label="操作" width="200">
        <template slot-scope="scope">
          <div style="display: flex; flex-direction: column; align-items: flex-start;">
            ...
            <div>
              <el-button size="small" type="info" @click="viewDetail(scope.row.id)">查看详情</el-button>
            </div>
          </div>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    openAddDialog() {
      ...
      this.form = {
        ...
        description: "",
        status: 0,
        creatorId: user.id, // 使用当前登录用户的 ID
        assigneeName: "",
        deadline: ""
      };
    ...
    viewDetail(taskId) {
      ...
      this.$router.push({
        path: '/task/detail', // 路由路径，确保和你的路由配置一致
        query: { id: taskId } // 将任务 ID 作为 query 参数传递
      });
    }
  },
  mounted() {
